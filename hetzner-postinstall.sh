...
wget http://apt.puppetlabs.com/pool/precise/main/f/facter/facter_1.7.6-1puppetlabs1_amd64.deb
wget http://apt.puppetlabs.com/pool/precise/main/p/puppet/puppet-common_2.7.26-1puppetlabs1_all.deb
wget http://apt.puppetlabs.com/pool/precise/main/p/puppet/puppet_2.7.26-1puppetlabs1_all.deb
dpkg -i facter_1.7.6-1puppetlabs1_amd64.deb
dpkg -i puppet-common_2.7.26-1puppetlabs1_all.deb
dpkg -i puppet_2.7.26-1puppetlabs1_all.deb
mkdir /root/.ssh
chmod 700 /root/.ssh
